...
namespace Radiator2000.Controls.Tabs
{
    ...
    public partial class RebristiyChern : UserControl
    {
        ...
        public void SwBuild(RebristiyChernCalculation calculations)
        {
            ...
            swModel.FeatureManager.FeatureLinearPattern2(calculations.Count, calculations.ChernCoefficients.b + calculations.ChernCoefficients.delt, 1, calculations.ChernCoefficients.delt, false, false, "NULL", "NULL", false);
        }
        #endregion
        ...
        public void InitCalculationsWindow(RebristiyChernCalculation calculations)
        {
            ...
            window.MegreberLabel.Content = string.Format("{0:0.0000}", calculations.ChernCoefficients.b);
